...
%% for VA_Ms_practicas_ejecicio1_22-23_enunciado _V3
...
%% 2c) Excess of propellant (if any). ounds complete while finding an initial angle such as the launcher
...
%Barrido angular, solución 1-0.6168 ángulo en grados. Ver
%multistage_launcher_gravity_turn_angle.m
%% Apartado 2             
steering_path = intMultiStage2DWithDrag([30 300], vertical_path.y(:,end) + [0; (1-0.6168)*pi/180; 0; 0], params);%steering angle injected
params = paramSet('T', [2718 798 83 0]*1e3,...
			     'Mp', [167.5 34.6 10.8 0]*1e3,...
			     'M', [185.015 38 12 3.38]*1e3,...
			     'tb',[150 125 600 inf],...
...
guided_path = intMultiStage2DWithDrag([300 875+2*6534], steering_path.y(:,end), params);
